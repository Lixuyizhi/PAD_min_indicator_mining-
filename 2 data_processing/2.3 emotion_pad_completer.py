...
def main(resample_rule='15min', debug=False):
    """主函数，支持自定义粒度"""
    input_file = f'./emo_data/emo_PAD/AG_combined_评论分析结果_{resample_rule}.xlsx' # 注意更改
    output_dir = './emo_data/emo_PAD_completed'
    os.makedirs(output_dir, exist_ok=True)
    output_file = os.path.join(output_dir, f'AG_combined_情绪补全_{resample_rule}.xlsx') # 注意更改
